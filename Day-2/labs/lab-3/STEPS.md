...
## Teach-it-back prompts (deck slide 38)
...
6. What every panel must carry before you ship it  
...
| `queries/` | Copy-paste PromQL / SQL helpers |
| `dashboards/host-health-reference.json` | Optional reference layout (import manually) |

---

## Before Day 3 (from the wrap-up)

- Export your dashboard JSON and keep it
- Add one panel of your own choosing
- Skim the Grafana alerting docs
- Bring one dashboard you find hard to read
